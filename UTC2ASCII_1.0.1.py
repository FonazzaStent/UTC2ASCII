...
Convert.place(relx=0.367, rely=0.911, height=24, width=67)
Convert.configure(text='''Convert''')


#Copy button
Copy=tk.Button(top)
Copy.place(relx=0.517, rely=0.911, height=24, width=47)
...
quitbutton.place (relx=0.733, rely=0.911, height=24, width=34)
quitbutton.configure(text='''Quit''')

#clear button
clearbutton=tk.Button(top)
clearbutton.place (relx=0.633, rely=0.911, height=24, width=34)
